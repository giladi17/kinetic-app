...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-full w-20 flex-col items-center py-6 pt-20 gap-2 kinetic-nav-bg bg-white/95 dark:bg-[#050505]/90 backdrop-blur-2xl z-40 border-r border-black/5 dark:border-white/[0.06]">
      {NAV_ITEMS.map(item => (
        <NavLink
          key={item.to}
          to={item.to}
