...
app.post('/api/nutrition/parse', requireAuth, asyncHandler(async (req, res) => {
  ...
  const FOODS = [
    // ── ירקות ──
    { name: 'עגבנייה',      kw: ['עגבנייה','עגבניות','עגבניה'],                  calG: 18,  protG: 0.9,  defG: 120 },
    { name: 'מלפפון',       kw: ['מלפפון','מלפפונים'],                            calG: 15,  protG: 0.7,  defG: 100 },
    { name: 'בצל',          kw: ['בצל'],                                          calG: 40,  protG: 1.1,  defG: 80  },
    { name: 'פלפל ירוק',    kw: ['פלפל ירוק'],                                    calG: 20,  protG: 0.9,  defG: 100 },
    { name: 'פלפל אדום',    kw: ['פלפל אדום'],                                    calG: 31,  protG: 1.0,  defG: 100 },
    { name: 'פלפל',         kw: ['פלפל'],                                         calG: 27,  protG: 1.0,  defG: 100 },
    { name: 'גזר',          kw: ['גזר','גזרים'],                                  calG: 41,  protG: 0.9,  defG: 100 },
    { name: 'חסה',          kw: ['חסה','סלט ירוק'],                               calG: 15,  protG: 1.4,  defG: 60  },
    { name: 'ברוקולי',      kw: ['ברוקולי'],                                       calG: 34,  protG: 2.8,  defG: 100 },
    { name: 'כרובית',       kw: ['כרובית'],                                        calG: 25,  protG: 2.0,  defG: 100 },
    { name: 'כרוב',         kw: ['כרוב'],                                          calG: 25,  protG: 1.3,  defG: 100 },
    { name: 'תירס',         kw: ['תירס'],                                          calG: 96,  protG: 3.4,  defG: 100 },
    { name: 'חציל',         kw: ['חציל','חצילים'],                                calG: 25,  protG: 1.0,  defG: 100 },
    { name: 'קישוא',        kw: ['קישוא','קישואים'],                              calG: 17,  protG: 1.2,  defG: 100 },
    { name: 'פטרייה',       kw: ['פטרייה','פטריות'],                              calG: 22,  protG: 3.1,  defG: 80  },
    { name: 'תרד',          kw: ['תרד'],                                           calG: 23,  protG: 2.9,  defG: 80  },
    { name: 'אפונה',        kw: ['אפונה'],                                         calG: 81,  protG: 5.4,  defG: 100 },
    { name: 'שעועית ירוקה', kw: ['שעועית ירוקה'],                                 calG: 31,  protG: 1.8,  defG: 100 },
    { name: 'זיתים',        kw: ['זיתים','זית'],                                  calG: 115, protG: 0.8,  defG: 50  },
    { name: 'בטטה',         kw: ['בטטה'],                                          calG: 86,  protG: 1.6,  defG: 150 },
    // ── תפוח אדמה must come before תפוח ──
    { name: 'תפוח אדמה',    kw: ['תפוח אדמה','פריטס'],                            calG: 77,  protG: 2.0,  defG: 150 },
    // ── פירות ──
    { name: 'תפוח',         kw: ['תפוח','תפוחים'],                                calU: 95,  protU: 0.5,  unit: 'יחידה', defQ: 1 },
    { name: 'בננה',         kw: ['בננה','בננות'],                                  calU: 105, protU: 1.3,  unit: 'יחידה', defQ: 1 },
    { name: 'תמר',          kw: ['תמר','תמרים'],                                  calU: 23,  protU: 0.2,  unit: 'יחידה', defQ: 3 },
    { name: 'תפוז',         kw: ['תפוז','תפוזים'],                                calU: 62,  protU: 1.2,  unit: 'יחידה', defQ: 1 },
    { name: 'תות שדה',      kw: ['תות שדה','תות','תותים'],                        calG: 32,  protG: 0.7,  defG: 100 },
    { name: 'ענבים',        kw: ['ענב','ענבים'],                                  calG: 69,  protG: 0.7,  defG: 100 },
    { name: 'מנגו',         kw: ['מנגו'],                                          calG: 60,  protG: 0.8,  defG: 150 },
    { name: 'אננס',         kw: ['אננס'],                                          calG: 50,  protG: 0.5,  defG: 150 },
    { name: 'אבטיח',        kw: ['אבטיח'],                                         calG: 30,  protG: 0.6,  defG: 200 },
    { name: 'אוכמניות',     kw: ['אוכמניות','בלוברי'],                            calG: 57,  protG: 0.7,  defG: 100 },
    { name: 'אשכולית',      kw: ['אשכולית'],                                       calU: 80,  protU: 1.6,  unit: 'יחידה', defQ: 1 },
    // ── פחמימות ──
    { name: 'שיבולת שועל',  kw: ['שיבולת','קוואקר','פתיתים','פתיתי'],            calG: 375, protG: 12.5, defG: 80  },
    { name: 'גרנולה',       kw: ['גרנולה'],                                        calG: 450, protG: 10,   defG: 50  },
    { name: 'אורז מלא',     kw: ['אורז מלא','אורז חום'],                          calG: 123, protG: 2.6,  defG: 150 },
    { name: 'אורז',         kw: ['אורז'],                                          calG: 130, protG: 2.7,  defG: 150 },
    { name: 'פסטה',         kw: ['פסטה','ספגטי','מקרוני','פנה'],                  calG: 131, protG: 5.0,  defG: 150 },
    { name: 'קינואה',       kw: ['קינואה'],                                        calG: 222, protG: 8.1,  defG: 100 },
    { name: 'קוסקוס',       kw: ['קוסקוס'],                                        calG: 176, protG: 6.0,  defG: 100 },
    { name: 'לחם מלא',      kw: ['לחם מלא','לחם שחור'],                            calU: 70,  protU: 3.0,  unit: 'פרוסה', defQ: 1 },
    { name: 'לחם',          kw: ['לחם','פרוסה','פרוסות','טוסט'],                  calU: 69,  protU: 2.4,  unit: 'פרוסה', defQ: 1 },
    { name: 'פריכייה',      kw: ['פריכייה','פריכיות','פריכייות'],                  calU: 38,  protU: 0.7,  unit: 'יחידה', defQ: 1 },
    { name: 'פיתה',         kw: ['פיתה','פיתות'],                                  calU: 165, protU: 5.5,  unit: 'יחידה', defQ: 1 },
    { name: 'לחמנייה',      kw: ['לחמנייה','לחמניות','באגל'],                      calU: 170, protU: 5.0,  unit: 'יחידה', defQ: 1 },
    { name: 'קורנפלקס',     kw: ['קורנפלקס','דגני בוקר'],                         calG: 380, protG: 7.0,  defG: 40  },
    // ── חלבונים — specific before generic ──
    ...
    { name: 'חזה עוף',      kw: ['חזה עוף','פילה עוף'],                           calG: 165, protG: 31,   defG: 150 },
    { name: 'שניצל',        kw: ['שניצל'],                                         calG: 230, protG: 22,   defG: 150 },
    { name: 'עוף',          kw: ['עוף','פרגית','שוק עוף'],                        calG: 209, protG: 26,   defG: 150 },
    { name: 'שווארמה',      kw: ['שווארמה','שאורמה'],                              calG: 230, protG: 20,   defG: 150 },
    { name: 'הודו',         kw: ['הודו','תרנגול הודו'],                            calG: 135, protG: 30,   defG: 150 },
    { name: 'טונה',         kw: ['טונה'],                                          calG: 116, protG: 26,   defG: 80  },
    { name: 'סלמון',        kw: ['סלמון'],                                         calG: 208, protG: 20,   defG: 100 },
    { name: 'דג לבן',       kw: ['בקלה','דג לבן','פילה דג','אמנון','דניס'],       calG: 82,  protG: 18,   defG: 100 },
    { name: 'בשר טחון',     kw: ['בשר טחון','המבורגר','בורגר'],                   calG: 254, protG: 26,   defG: 150 },
    { name: 'סטייק',        kw: ['סטייק','אנטריקוט','פילה בקר'],                  calG: 271, protG: 26,   defG: 150 },
    { name: 'בשר',          kw: ['בשר'],                                           calG: 250, protG: 26,   defG: 150 },
    { name: 'טופו',         kw: ['טופו'],                                          calG: 76,  protG: 8,    defG: 100 },
    { name: 'פלאפל',        kw: ['פלאפל'],                                         calG: 333, protG: 13,   defG: 90  },
    // ── מוצרי חלב — specific before generic ──
    { name: "קוטג'",        kw: ["קוטג","קוטג'"],                                 calG: 98,  protG: 11,   defG: 200 },
    { name: 'גבינה צהובה',  kw: ['גבינה צהובה'],                                  calG: 364, protG: 25,   defG: 30  },
    { name: 'גבינה לבנה',   kw: ['גבינה לבנה','גבינה 5%','גבינה 9%'],            calG: 105, protG: 12,   defG: 100 },
    { name: 'גבינה',        kw: ['גבינה'],                                         calG: 300, protG: 20,   defG: 30  },
    { name: 'יוגורט יווני', kw: ['יוגורט יווני'],                                  calG: 87,  protG: 10,   defG: 150 },
    { name: 'יוגורט פרו',   kw: ['יוגורט פרו','יוגורט 0%'],                       calG: 57,  protG: 8.5,  defG: 150 },
    { name: 'יוגורט',       kw: ['יוגורט'],                                        calG: 61,  protG: 3.5,  defG: 150 },
    { name: 'חלב מתאמנים',  kw: ['חלב מתאמנים','חלב חלבון','גולדן'],              calG: 55,  protG: 5.5,  defG: 250 },
    { name: 'חלב',          kw: ['חלב'],                                           calG: 42,  protG: 3.4,  defG: 200 },
    { name: 'שייק חלבון',   kw: ['שייק','פרוטאין','ווי','מוגול'],                 calU: 130, protU: 25,   unit: 'מנה', defQ: 1 },
    { name: 'ריקוטה',       kw: ['ריקוטה'],                                        calG: 174, protG: 11,   defG: 100 },
    // ── קטניות ──
    { name: 'שעועית',       kw: ['שעועית שחורה','שעועית אדומה','שעועית'],          calG: 132, protG: 8.9,  defG: 150 },
    { name: 'עדשים',        kw: ['עדשים'],                                         calG: 116, protG: 9,    defG: 150 },
    { name: 'חומוס',        kw: ['חומוס'],                                         calG: 166, protG: 8,    defG: 100 },
    { name: 'פול',          kw: ['פול'],                                           calG: 88,  protG: 8,    defG: 150 },
    // ── שומנים ──
    { name: 'אבוקדו',       kw: ['אבוקדו'],                                        calU: 240, protU: 3,    unit: 'יחידה', defQ: 1 },
    { name: 'טחינה',        kw: ['טחינה'],                                         calG: 595, protG: 17,   defG: 30  },
    { name: 'שמן זית',      kw: ['שמן זית','שמן'],                                 calG: 884, protG: 0,    defG: 10  },
    { name: 'חמאת בוטנים',  kw: ['חמאת בוטנים'],                                  calG: 588, protG: 25,   defG: 30  },
    { name: 'חמאה',         kw: ['חמאה'],                                          calG: 717, protG: 0.9,  defG: 10  },
    { name: 'שקדים',        kw: ['שקדים'],                                         calG: 580, protG: 20,   defG: 30  },
    { name: 'אגוזי מלך',    kw: ['אגוזי מלך','אגוז מלך'],                         calG: 654, protG: 15,   defG: 30  },
    { name: 'אגוזי קשיו',   kw: ['קשיו','אגוזי קשיו'],                            calG: 553, protG: 18,   defG: 30  },
    { name: 'אגוזים',       kw: ['אגוזים'],                                        calG: 607, protG: 14,   defG: 30  },
    // ── שונות ──
    { name: 'שוקולד מריר',  kw: ['שוקולד מריר'],                                   calG: 598, protG: 7.5,  defG: 30  },
    { name: 'שוקולד',       kw: ['שוקולד'],                                        calG: 535, protG: 6,    defG: 30  },
    { name: 'קפה',          kw: ['קפה','אספרסו','לאטה'],                           calG: 2,   protG: 0.1,  defG: 200 },
    { name: 'מיץ',          kw: ['מיץ תפוזים','מיץ תפוח','מיץ'],                  calG: 45,  protG: 0.7,  defG: 200 },
  ]
...
- אם המשתמש מדווח על תרגיל שביצע (משקל וחזרות), השתמש בכלי add_workout_log כדי לרשום אותו למסד הנתונים.
- אם הוא לא ציין משקל, תשאל אותו "כמה שמת על המוט?" לפני שתרשום.
- תמיד תפרגן על משקלים כבדים או שיפור בביצועים — PR חדש זה אירוע!`
